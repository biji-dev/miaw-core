...
describe('Enums', () => {
  describe('PredefinedLabelId', () => {
    ...
    it('should have 5 predefined labels', () => {
      const values = Object.values(PredefinedLabelId).filter((v) => typeof v === 'number');
  ...
  describe('ConnectionState', () => {
    it('should have valid connection states', () => {
      const states: ConnectionState[] = ['disconnected', 'connecting', 'connected', 'reconnecting', 'qr_required'];
      expect(states).toHaveLength(5);
    });

    it('should accept valid connection states', () => {
      const validStates: ConnectionState[] = ['disconnected', 'connecting', 'connected', 'reconnecting', 'qr_required'];
...
describe('Type Guards and Validation', () => {
  ...
  describe('MiawMessage', () => {
    ...
    it('should create a message with all media types', () => {
      const mediaTypes: MiawMessage['type'][] = ['image', 'video', 'audio', 'document', 'sticker'];
