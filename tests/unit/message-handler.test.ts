...
describe('MessageHandler', () => {
  describe('formatPhoneToJid', () => {
    it('should format raw phone number to JID', () => {
      expect(MessageHandler.formatPhoneToJid('1234567890')).toBe('1234567890@s.whatsapp.net');
      expect(MessageHandler.formatPhoneToJid('628123456789')).toBe('628123456789@s.whatsapp.net');
    });

    it('should handle phone numbers with special characters', () => {
      expect(MessageHandler.formatPhoneToJid('+1-234-567-8900')).toBe('12345678900@s.whatsapp.net');
      expect(MessageHandler.formatPhoneToJid('(628) 123 456 789')).toBe('628123456789@s.whatsapp.net');
      expect(MessageHandler.formatPhoneToJid('628.123.456.789')).toBe('628123456789@s.whatsapp.net');
    });

    it('should return existing JIDs as-is', () => {
      expect(MessageHandler.formatPhoneToJid('1234567890@s.whatsapp.net')).toBe('1234567890@s.whatsapp.net');
      expect(MessageHandler.formatPhoneToJid('abcd1234@lid')).toBe('abcd1234@lid');
      expect(MessageHandler.formatPhoneToJid('group123@g.us')).toBe('group123@g.us');
      expect(MessageHandler.formatPhoneToJid('12345@c.us')).toBe('12345@c.us');
      expect(MessageHandler.formatPhoneToJid('status@broadcast')).toBe('status@broadcast');
      expect(MessageHandler.formatPhoneToJid('newsletter@newsletter')).toBe('newsletter@newsletter');
    });
  ...
  describe('isGroupJid', () => {
    ...
    it('should return false for individual chat JIDs', () => {
      expect(MessageHandler.isGroupJid('1234567890@s.whatsapp.net')).toBe(false);
  ...
  describe('extractChatId', () => {
    it('should extract chat ID from message', () => {
      ...
      expect(MessageHandler.extractChatId(message)).toBe('1234567890@s.whatsapp.net');
    });
